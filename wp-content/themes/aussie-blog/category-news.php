                ...
                <div class="aussie-casino__category_container">
                    ...
                    <div class="aussie-casino__category_filter-sort--wrap">
                        ...
                        <form action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="filter-category"
                            ...
                            $termID = 6; // get_queried_object()->term_id; - динамическое получение ID текущей рубрики
                            ...
                            echo '<input class="input-btn" type="radio" name="incategoryfilter" value="6" id="news-6">';
                            echo '<label class="label-btn" name="incategoryfilter" for="news-6" value="6">All news</label>';
                            echo '</div>';
                            foreach ($termchildren as $child) {
                                $term = get_term_by('id', $child, $taxonomyName);
                                echo '<div class="aussie-casino__category_form-item"><input class="input-btn" type="radio" name="incategoryfilter" value="' . $term->term_id . '" id="news-' . $term->term_id . '"/>';
                                echo '<label class="label-btn" name="incategoryfilter" for="news-' . $term->term_id . '" value="' . $term->term_id . '">' . $term->name . '</label></div>';
                            }
                            echo '</div>'; ?>
