...
<section class="fixed-sidebar" id="fixed-sidebar" onclick="change()">
    <div class="fixed-sidebar__btn_wrap">
        <p class="fixed-sidebar__btn_title-1">Aussie play</p>
        <p class="fixed-sidebar__btn_title-2">Go to</p>
    </div>
